...
<body>
    ...
    <div class="layout">
        ...
        <aside class="sidebar">
            ...
            <a href="/barberias" class="btn-inicio">
                ← Volver a Inicio
            </a>
        ...
        <main class="main">
            ...
            <div class="grid">
                ...
                <div class="card">
                    ...
                    <a href="admin/barberias">Entrar</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="/admin/servicios">Entrar</a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="/admin/usuarios">Entrar</a>
                </div>
