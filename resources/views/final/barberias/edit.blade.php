...
<body>
    ...
    <div class="page">
        ...
        <form action="/admin/barberias/{{ $barberia->id }}" method="POST" enctype="multipart/form-data">
            ...
            <textarea name="descripcion">{{ $barberia->descripcion }}</textarea>
        ...
        <a href="/admin/barberias" class="volver">
            ← Volver al listado
        </a>
